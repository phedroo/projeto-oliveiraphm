...
setores_novos <- c(
  "Agricultura", "Florestas e Uso da Terra", "Operações de Combustíveis Fósseis",
  "Manufatura", "Extração Mineral", "Energia",
  "Transporte", "Resíduos"
)
...
# Salvar
# write_rds(emissions_sources_15_20_renomeada, "../data/emissions_sources_antiga.rds")
```
