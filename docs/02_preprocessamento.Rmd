...
# Tratando base --------------------------------------------------
emissions_sources_21_23_setores <- base_ct_att |> 
...
```{r,eval=FALSE}
emissions_sources_21_23_subsetores <- base_ct_att |> 
  rename(city_ref = fonte,
         emissao = emissao_co2e,
         state = estado,
         year = ano) |>
...
##### Pegando setores da base antiga
...
emissions_sources |> pull(sector_name) |> unique()
  # # [1] "agriculture"            "forestry_and_land_use" 
  # [3] "fossil_fuel_operations" "manufacturing"         
  # [5] "mineral_extraction"     "power"                 
...
# Extraindo setores da base antiga
  # Antes, visualizar setores da nova base para padronizarmos:
      base_ct_att |> pull(setor) |> unique()
        # [1] "Agricultura"                      
        # [2] "Edificações"                      
        # [3] "Florestas e Uso da Terra"         
        # [4] "Transporte"                       
        # [5] "Energia"                          
        # [6] "Resíduos"                         
        # [7] "Operações de Combustíveis Fósseis"
        # [8] "Manufatura"                       
        # [9] "Extração Mineral"  
...
climate_trace_setores <- emissions_sources_15_20_setores |> 
  full_join(emissions_sources_21_23_setores,
...
climate_trace_subsetores <- emissions_sources_15_20_subsetores |> 
  full_join(emissions_sources_21_23_subsetores,
