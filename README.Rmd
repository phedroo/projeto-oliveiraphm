...
A base de dados do GOSAT disponibiliza informações de XCH₄ até o ano de 2021. Para possibilitar a análise de regressão, realizou-se a predição dos valores para 2022 e 2023 por meio do método de regressão linear simples, utilizando os dados observados no período de 2015 a 2021 como base de treinamento.
...
Visualização em acumulado de CO2 equivalente no período de 2021 a 2023 (somente considerada a base climate TRACE nova, para que se evite os outliers)
