...
#### Tratamento dos dados da sif - dando errado
```{r, eval=FALSE}
...
# Visualizar trechos específicos
oco2_sif_preview |> 
  slice(27462771:27462772)

# Conferir
# as_datetime(946744882, origin = "1993-01-01", tz = "America/Sao_Paulo")
# as_datetime(946744882/1000, origin = "1993-01-01", tz = "America/Sao_Paulo")
```
...
#   ggplot(aes(x=longitude,y=latitude)) +
#   geom_point()
#imagem gerada salva no wpp - lerdo para rodar
```

#### Classificando cada ponto em município - não feito
```{r, eval=FALSE}
library(sf)
library(dplyr)
