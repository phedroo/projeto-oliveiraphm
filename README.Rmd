...
1- Na incorporação retirar os subsetores (para não contar duas vezes)
2- fazer a soma de emissão por setor
3- pivto_wider com as emissão para os diferentes setores nas colunas
